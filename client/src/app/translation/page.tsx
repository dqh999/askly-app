...
export default function TranslationPractice() {
  ...
  const breadcrumbItems = [
    ...
    { label: 'Translation', href: '/translation', isCurrent: true },
    // { label: 'Overview', isCurrent: true },
  ];
  return (
    <Layout breadcrumbItems={breadcrumbItems}>
      <div className="max-w-3xl mx-auto bg-white border border-primary-500 shadow-sm rounded-lg p-6">
        <h1 className="text-3xl font-bold text-center text-red-900 mb-4">
